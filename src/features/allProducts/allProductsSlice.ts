...
const initialAllProducts: Array<any> = [];
export const allProductsReducer = (allProducts = initialAllProducts, action: any) => {
    switch(action.type) {
        case 'allProducts/addProduct':
            return [...allProducts, action.payload];
        case 'allProducts/removeProduct':
